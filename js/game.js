	...
	function startGame() {
        ...
        // head start the game
   /*     if(playGame == false && bodyControl != "S"){
                console.log('head start game');
				playGame = true;
...
*/
		...
		$(window).keydown(function(e) {
			...
			if (playGame == false) {
                console.log('keyboard start game');
				playGame = true;
	...
	function animate() {
        ...
        // bodyControl and keyboard control
		if (player.moveRight || bodyControl == "U") {
			player.vX = 3;
		} else {
			player.vX = -3;
		};
		
		if (player.moveUp || bodyControl == "L" ) {
			player.vY = -3;
		};
		
		if (player.moveDown || bodyControl == "R") {
			player.vY = 3;
		};
